...
namespace pd{ namespace vision{
    ...
    namespace vis{
        ...
        class PlotLevenbergMarquardt : public Plot{
            ...
            public:
            PlotLevenbergMarquardt(int nIterations,const Eigen::VectorXd& chi2,const Eigen::VectorXd &dChi2,const Eigen::VectorXd &chi2pred,const Eigen::VectorXd& lambda,const Eigen::VectorXd& stepSize,const Eigen::VectorXd &rho)
            : _chi2(chi2)
            , _chi2pred(chi2pred)
            , _lambda(lambda)
            , _stepSize(stepSize)
