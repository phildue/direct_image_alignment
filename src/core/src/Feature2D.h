...
public:
    ...
    Feature2D(const Vec2d& position, std::shared_ptr<FrameRgb> frame,size_t level = 0U, double response = 0.0, const VecXd& descriptor = VecXd::Zero(10), std::shared_ptr<Point3D> p3d = nullptr);
