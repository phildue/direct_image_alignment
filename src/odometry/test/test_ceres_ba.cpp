...
public:
    ...
    template <typename T>
    bool operator()(const T* const poseData,const T* const intrinsics, const T* const pointData, T* residuals) const
    {
    ...
    static ceres::CostFunction *Create(double observed_x,
        ...
        return (new ceres::AutoDiffCostFunction<ReprojectionErrorManifold, 2, Sophus::SE3d::num_parameters,3, 3>(
...
public:
    ...
    template <typename T>
    bool operator()(const T* const pose,const T* const intrinsics, const T* const pWcs, T* residuals) const
    {
        T pCcs[3];
