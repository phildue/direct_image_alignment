...
TEST(PoseGraphTest,Create)
{
    auto poseGraph = std::make_shared<PoseGraph>(utils::loadTrajectory(TEST_RESOURCE"/trajectory.txt"));

}
TEST(PoseGraphTest,Interpolate)
{
    SE3d pose0,pose2;
    ...
    poses[0] = pose0;
    poses[2] = pose2;
    auto poseGraph = std::make_shared<PoseGraph>(poses);
